[tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4] Operating Details
====================================

Generated On: 2026-03-14 16:12:01 UTC
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   rekhamei/tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4-amd64 (https://hub.docker.com/r/rekhamei/tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4-amd64)
...
.. code-block::
   ...
   docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4 \
          ...
          rekhamei/tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4-amd64
...
[tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4] Github Repo
---------------
...
.. important::
   https://tml-multi-agenticai-iot-3f10-ml-agenticai-0fd4.readthedocs.io
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=34191, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=42731, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=35843, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=42641, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=36249, HPDEHOST=172.17.0.2, HPDEPORT=36047, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=44279

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-573-tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-preprocess-1484-tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-ml-2799-tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-predict-7836-tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-agenticai-3436-tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
