[tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4] Details
============================
...
.. list-table::
   ...
   * - **User Parameter**
     - **Chosen Value**
   * - solutionname
     - tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4
   * - solutiontitle
...
.. list-table::
   ...
   * - ML Output Github Link
     - `Output Data URL <https:\/\/github.com/Rekhamei/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/mldata/iotlogistic>`_
