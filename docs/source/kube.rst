Scaling [tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4] With Kubernetes
===========================
...
Based on your TML solution [tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresstml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml -f ollama.yml

tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml
------------------------

.. important::
   Copy and Paste this YAML file: tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/Rekhamei/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/ymls/tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4
...
.. code-block:: YAML
   ...
   ################# tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml
     ...
     kind: Deployment
     metadata:
       name: tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4
     spec:
       selector:
         matchLabels:
           app: tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4
       ...
       template:
         ...
         spec:
           containers:
           - name: tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4
             image: rekhamei/tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4'
             - name: SOLUTIONDAG
   ...
   ---
     ...
     kind: Service
     metadata:
       name: tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4-visualization-service
       labels:
         app: tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-0fd4.yml
